...
class CardList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ExpansionContent expansionContent = ModalRoute.of(context).settings.arguments;
    return Scaffold(
      appBar: AppBar(
...
//    final String targetPath = 'assets/img/cards/jp/${content.generation.toLowerCase()}/${content.setCode.toLowerCase()}.png';
  ...
  Future<List<CardContent>> getCardListByExpansion(BuildContext context, ExpansionContent content) async {
    ...
    final List<dynamic> jsonRes = jsonDecode(await DefaultAssetBundle.of(context).loadString(jsonPath));
    final List<CardContent> _cardList = CardContents.fromJson(jsonRes).getCardContentList();
    return _cardList;
  }
}
