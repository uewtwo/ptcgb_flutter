...
class Expansions extends StatelessWidget {
  ...
  Widget _expansionItem(BuildContext context, ExpansionContent content, int index) {
    return Container(
  ...
  Image _expansionImage(ExpansionContent content) {
    String targetPath = 'assets/img/expansions/${content.generation}/${content.name}.png';
    // ↓DebugCode
  ...
  Future<List<ExpansionContent>> getExpansionContentsByGen(
    ...
    final List<ExpansionContent> _expansions = ExpansionContents.fromJson(jsonRes).getExpansionContentList();
